# -*- encoding: utf-8 -*-
# stub: bx_block_dashboard-9a14cb77 0.0.3 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_dashboard-9a14cb77".freeze
  s.version = "0.0.3"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_dashboard".freeze
  s.rubygems_version = "3.1.6".freeze
  s.summary = "BxBlockDashboard".freeze
