# -*- encoding: utf-8 -*-
# stub: bx_block_coupon_cg-1da92412 0.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_coupon_cg-1da92412".freeze
  s.version = "0.0.1"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_coupon_cg".freeze
  s.rubygems_version = "3.1.6".freeze
  s.summary = "BxBlockCouponCg".freeze
