# -*- encoding: utf-8 -*-
# stub: bx_block_search 0.1.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<bx_block_comments-568532a5>.freeze, ["= 0.0.25"])
    s.add_runtime_dependency(%q<bx_block_login-3d0582b5>.freeze, [">= 0"])
    s.add_runtime_dependency(%q<bx_block_posts-3dc5b993>.freeze, ["~> 0.0.14"])
    ...
    s.add_dependency(%q<bx_block_comments-568532a5>.freeze, ["= 0.0.25"])
    s.add_dependency(%q<bx_block_login-3d0582b5>.freeze, [">= 0"])
    s.add_dependency(%q<bx_block_posts-3dc5b993>.freeze, ["~> 0.0.14"])
