# -*- encoding: utf-8 -*-
# stub: bx_block_catalogue-0e5da613 0.0.11 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_catalogue-0e5da613".freeze
  s.version = "0.0.11"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_catalogue".freeze
  s.rubygems_version = "3.1.6".freeze
  s.summary = "BxBlockCatalogue".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<bx_block_login-3d0582b5>.freeze, [">= 0"])
