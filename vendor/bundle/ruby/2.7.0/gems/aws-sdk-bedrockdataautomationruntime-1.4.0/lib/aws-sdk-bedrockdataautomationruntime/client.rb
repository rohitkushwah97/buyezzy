...
module Aws::BedrockDataAutomationRuntime
  ...
  class Client < Seahorse::Client::Base
    ...
    @identifier = :bedrockdataautomationruntime
    ...
    add_plugin(Aws::BedrockDataAutomationRuntime::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::BedrockDataAutomationRuntime::EndpointProvider] :endpoint_provider
    #     The endpoint provider used to resolve endpoints. Any object that responds to
    #     `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to
    #     `Aws::BedrockDataAutomationRuntime::EndpointParameters`.
    #
    ...
    #   Invocation arn.
    #
    # @return [Types::GetDataAutomationStatusResponse] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::GetDataAutomationStatusResponse#status #status} => String
    ...
    #
    #   resp = client.get_data_automation_status({
    ...
    #
    # @overload get_data_automation_status(params = {})
    # @param [Hash] params ({})
    ...
    # @example Request syntax with placeholder values
    #
    #   resp = client.invoke_data_automation_async({
    ...
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/bedrock-data-automation-runtime-2024-06-13/InvokeDataAutomationAsync AWS API Documentation
    #
    # @overload invoke_data_automation_async(params = {})
    # @param [Hash] params ({})
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::BedrockDataAutomationRuntime')
      )
