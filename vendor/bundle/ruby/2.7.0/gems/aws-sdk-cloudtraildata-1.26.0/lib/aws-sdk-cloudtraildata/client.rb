...
module Aws::CloudTrailData
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::CloudTrailData::Plugins::Endpoints)
    ...
    #     sending the request.
    #
    #   @option options [Aws::CloudTrailData::EndpointProvider] :endpoint_provider
    ...
    # request.
    #
    # @option params [required, Array<Types::AuditEvent>] :audit_events
    ...
    #
    # @return [Types::PutAuditEventsResponse] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::PutAuditEventsResponse#failed #failed} => Array&lt;Types::ResultErrorEntry&gt;
    #   * {Types::PutAuditEventsResponse#successful #successful} => Array&lt;Types::AuditEventResultEntry&gt;
    #
    ...
    #   resp.successful[0].event_id #=> String
    #   resp.successful[0].id #=> String
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/cloudtrail-data-2021-08-11/PutAuditEvents AWS API Documentation
    #
    # @overload put_audit_events(params = {})
    # @param [Hash] params ({})
    def put_audit_events(params = {}, options = {})
      req = build_request(:put_audit_events, params)
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::CloudTrailData')
      )
