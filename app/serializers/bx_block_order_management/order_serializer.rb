...
module BxBlockOrderManagement
  class OrderSerializer < BuilderBase::BaseSerializer
    attributes(:id, :order_number, :amount, :account_id, :coupon_code_id, :delivery_address_id, :sub_total, :total,
      :status, :custom_label, :applied_discount, :cancellation_reason, :order_date, :is_gift, :placed_at, :confirmed_at, :in_transit_at, :delivered_at, :cancelled_at, :refunded_at, :source, :shipment_id, :delivery_charges, :tracking_url, :schedule_time, :payment_failed_at, :payment_pending_at, :returned_at, :tax_charges, :deliver_by, :tracking_number, :is_error, :delivery_error_message, :order_status_id, :is_group, :is_availability_checked, :shipping_charge, :shipping_discount, :shipping_net_amt, :shipping_total, :total_tax, :created_at, :updated_at, :delivery_addresses, :razorpay_order_id, :charged, :invoice_id, :invoiced)
    ...
    attribute :order_transaction do |object|
      object.order_transaction if object.present?
    end
  end
end
