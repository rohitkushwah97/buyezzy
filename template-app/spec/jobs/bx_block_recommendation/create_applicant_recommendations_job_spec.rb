...
RSpec.describe BxBlockRecommendation::CreateApplicantRecommendationsJob, type: :job do
  ...
  describe "#perform_now" do
    it "create applicant recommendation" do
      ...
      res = described_class.perform_now(internship)
      expect(res).to eq(nil)
    end

    it "got error applicant recommendation" do
      ActiveJob::Base.queue_adapter = :test
      res = described_class.perform_now(internship)
      expect(res).to eq(nil)
    end
