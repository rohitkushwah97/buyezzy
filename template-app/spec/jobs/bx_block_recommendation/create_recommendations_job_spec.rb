...
RSpec.describe BxBlockRecommendation::CreateRecommendationsJob, type: :job do
  ...
  describe "#perform_now" do
    it "create recommendation" do
      ...
      res = described_class.perform_now(career_interest.user_survey.version_id,career_interest.role_id)
