...
RSpec.describe BxBlockAdmin::ImportInternJob, type: :job do
  ...
  let(:model_class_name) { 'AccountBlock::InternUser' }

  before do
    CSV.open(csv_file_path, 'w') do |csv|
      csv << %w[email password date_of_birth]
      csv << ['test15@example.com', 'password1234', '28-08-1998']
      csv << ['test2@example.com', 'password123', '28-08-1997']
      csv << ['invalid_email', 'password123', '28-08-1995']
    end
  end
