# -*- encoding: utf-8 -*-
# stub: bx_block_stripe_integration 2.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<stripe_event>.freeze, ["~> 2.7.0"])
    s.add_runtime_dependency(%q<stripe>.freeze, ["~> 5.55.0"])
    s.add_development_dependency(%q<byebug>.freeze, [">= 0"])
    s.add_development_dependency(%q<cane>.freeze, [">= 0"])
    s.add_development_dependency(%q<factory_bot>.freeze, ["< 6.4.5"])
    ...
    s.add_dependency(%q<stripe_event>.freeze, ["~> 2.7.0"])
    s.add_dependency(%q<stripe>.freeze, ["~> 5.55.0"])
    s.add_dependency(%q<byebug>.freeze, [">= 0"])
    s.add_dependency(%q<cane>.freeze, [">= 0"])
    s.add_dependency(%q<factory_bot>.freeze, ["< 6.4.5"])
