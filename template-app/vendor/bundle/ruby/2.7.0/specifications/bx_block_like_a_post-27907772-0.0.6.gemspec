# -*- encoding: utf-8 -*-
# stub: bx_block_like_a_post-27907772 0.0.6 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_like_a_post-27907772".freeze
  s.version = "0.0.6"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_like_a_post".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockLikeAPost".freeze
