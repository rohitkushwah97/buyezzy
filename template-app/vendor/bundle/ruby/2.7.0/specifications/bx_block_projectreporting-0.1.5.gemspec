# -*- encoding: utf-8 -*-
# stub: bx_block_projectreporting 0.1.5 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_projectreporting".freeze
  s.version = "0.1.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "allowed_push_host" => "https://gemfury.com", "infra_dependencies" => "" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Denys".freeze]
  s.date = "2024-05-01"
  s.email = ["denys.taradada@x.builder.ai".freeze]
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_projectreporting".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockProjectreporting".freeze
