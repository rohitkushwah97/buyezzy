# -*- encoding: utf-8 -*-
# stub: bx_block_posts-3dc5b993 1.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_posts-3dc5b993".freeze
  s.version = "1.1.0"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_posts".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockPosts".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<activestorage-validator>.freeze, [">= 0"])
    s.add_runtime_dependency(%q<active_storage_validations>.freeze, [">= 0"])
    s.add_runtime_dependency(%q<rswag>.freeze, [">= 0"])
    s.add_development_dependency(%q<public_activity>.freeze, [">= 0"])
    ...
    s.add_development_dependency(%q<rspec-sonarqube-formatter>.freeze, [">= 0"])
    ...
    s.add_dependency(%q<activestorage-validator>.freeze, [">= 0"])
    s.add_dependency(%q<active_storage_validations>.freeze, [">= 0"])
    ...
    s.add_dependency(%q<rspec-sonarqube-formatter>.freeze, [">= 0"])
