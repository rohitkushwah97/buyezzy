# -*- encoding: utf-8 -*-
# stub: bx_block_notifsettings-296428d4 1.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_notifsettings-296428d4".freeze
  s.version = "1.1.0"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_notifsettings".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockNotifsettings".freeze
