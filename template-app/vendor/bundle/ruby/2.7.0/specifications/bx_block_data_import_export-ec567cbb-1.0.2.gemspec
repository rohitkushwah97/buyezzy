# -*- encoding: utf-8 -*-
# stub: bx_block_data_import_export-ec567cbb 1.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_data_import_export-ec567cbb".freeze
  s.version = "1.0.2"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_data_import_export".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockDataImportExport".freeze
