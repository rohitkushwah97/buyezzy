# -*- encoding: utf-8 -*-
# stub: bx_block_wishlist 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_wishlist".freeze
  s.version = "0.1.1"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_wishlist".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockWishlist".freeze
