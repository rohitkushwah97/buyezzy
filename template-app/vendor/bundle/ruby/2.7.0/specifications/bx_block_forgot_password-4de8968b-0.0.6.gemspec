# -*- encoding: utf-8 -*-
# stub: bx_block_forgot_password-4de8968b 0.0.6 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_forgot_password-4de8968b".freeze
  s.version = "0.0.6"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_forgot_password".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockForgotPassword".freeze
