# -*- encoding: utf-8 -*-
# stub: bx_block_block_users-eefa7b2b 1.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_block_users-eefa7b2b".freeze
  s.version = "1.1.0"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_block_users".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockBlockUsers".freeze
