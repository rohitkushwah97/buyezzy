# -*- encoding: utf-8 -*-
# stub: bx_block_roles_permissions-c50949d0 1.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_roles_permissions-c50949d0".freeze
  s.version = "1.1.0"
  ...
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_roles_permissions".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockRolesPermissions".freeze
