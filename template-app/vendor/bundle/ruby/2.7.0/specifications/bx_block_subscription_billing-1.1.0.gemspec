# -*- encoding: utf-8 -*-
# stub: bx_block_subscription_billing 1.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_subscription_billing".freeze
  s.version = "1.1.0"
  ...
  s.date = "2024-03-22"
  s.description = "Description of BxBlockSubscriptionBilling.".freeze
  s.email = ["arihant.nahar@protonshub.com".freeze]
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_subscription_billing".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "Summary of BxBlockSubscriptionBilling.".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<pg>.freeze, ["~> 1.3.5"])
    ...
    s.add_dependency(%q<pg>.freeze, ["~> 1.3.5"])
