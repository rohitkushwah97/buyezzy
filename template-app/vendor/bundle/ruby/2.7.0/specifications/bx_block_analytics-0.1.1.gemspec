# -*- encoding: utf-8 -*-
# stub: bx_block_analytics 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "bx_block_analytics".freeze
  s.version = "0.1.1"
  ...
  s.executables = ["rake".freeze, "standardrb".freeze, "rspec".freeze, "deploy_block".freeze]
  s.files = ["bin/deploy_block".freeze, "bin/rake".freeze, "bin/rspec".freeze, "bin/standardrb".freeze]
  s.homepage = "https://gitlab.builder.ai/builder/builder-bx/bx/blocks/ruby/engines/bx_block_analytics".freeze
  s.rubygems_version = "3.3.22".freeze
  s.summary = "BxBlockAnalytics".freeze
