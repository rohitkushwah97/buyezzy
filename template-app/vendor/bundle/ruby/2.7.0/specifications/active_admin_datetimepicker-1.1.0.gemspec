# -*- encoding: utf-8 -*-
# stub: active_admin_datetimepicker 1.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<activeadmin>.freeze, [">= 2.14.0", "< 4.0"])
  else
    s.add_dependency(%q<activeadmin>.freeze, [">= 2.14.0", "< 4.0"])
  end
end
