# -*- encoding: utf-8 -*-
# stub: bx_block_builder_analytics 0.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.executables = ["deploy_block".freeze, "rake".freeze, "rspec".freeze, "standardrb".freeze]
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<bx_block_analytics>.freeze, ["~> 0.1.0.beta.0"])
    ...
    s.add_dependency(%q<bx_block_analytics>.freeze, ["~> 0.1.0.beta.0"])
