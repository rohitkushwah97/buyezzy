...
RSpec.configure do |config|
  ...
  config.swagger_docs = {
    'v1/swagger.json' => {
      openapi: '3.0.1',
      info: {
        title: 'bx_block_login',
        version: '1.0.0',
        description: 'login block API'
      },
      servers: [
        {
        ...
        schemas: {
          email_account: {
            ...
            properties: {
              ...
              type: { type: :string, nullable: false, example: 'email_account' },
              attributes: {
                type: :object,
                properties: {
                  id: { type: :string, nullable: false, example: '1' },
          ...
          sms_account: {
            ...
            properties: {
              ...
              attributes: {
                ...
                properties: {
                  id: { type: :string, nullable: false, example: '1' },
                  phone: { type: :string, nullable: true, example: '+919790918544' },
                  password: { type: :string, nullable: true, example: 'test' },
                  created_at: { type: :string, format: :datetime, nullable: true, example: '2022-12-17 10:29:55' },
                  updated_at: { type: :string, format: :datetime, nullable: true, example: '2022-12-17 10:29:55' }
                }
