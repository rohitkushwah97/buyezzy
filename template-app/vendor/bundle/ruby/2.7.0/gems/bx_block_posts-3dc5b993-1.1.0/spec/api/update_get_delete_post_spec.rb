...
RSpec.describe "/bx_block_posts", :jwt do
  ...
  path "/posts/posts/{id}" do
    get "show post " do
      # tags "bx_block_posts", "post", "show"
      tags "show"
    ...
    put "update a post" do
      # tags "bx_block_posts", "post", "update"
      tags "create"
    ...
    delete "delete post " do
      # tags "bx_block_posts", "post", "delete"
      tags "delete"
      produces "application/json"
      parameter name: :token, in: :header, type: :string,required:true, example: "{{bx_blocks_api_token}}"
      parameter name: :id, in: :path, type: :integer,required:true, example: 1
      ...
      response "200", :success do
        schema type: :object,properties:{
          message: {
            type: :string,example: "Post deleted succesfully!"
          }
        }
        run_test!
      end
