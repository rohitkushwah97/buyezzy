...
module Aws::SageMakerMetrics
  ...
  class Client < Seahorse::Client::Base
    ...
    add_plugin(Aws::SageMakerMetrics::Plugins::Endpoints)
    ...
    #
    # @return [Types::BatchPutMetricsResponse] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::BatchPutMetricsResponse#errors #errors} => Array&lt;Types::BatchPutMetricsError&gt;
    #
    # @example Request syntax with placeholder values
    #
    ...
    #
    #   resp.errors #=> Array
    #   resp.errors[0].code #=> String, one of "METRIC_LIMIT_EXCEEDED", "INTERNAL_ERROR", "VALIDATION_ERROR", "CONFLICT_ERROR"
    #   resp.errors[0].metric_index #=> Integer
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/sagemaker-metrics-2022-09-30/BatchPutMetrics AWS API Documentation
    #
    # @overload batch_put_metrics(params = {})
    # @param [Hash] params ({})
    def batch_put_metrics(params = {}, options = {})
      req = build_request(:batch_put_metrics, params)
      req.send_request(options)
    end
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::SageMakerMetrics')
      )
