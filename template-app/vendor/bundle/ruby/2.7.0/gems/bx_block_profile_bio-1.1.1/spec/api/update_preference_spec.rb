...
RSpec.describe "/profile_bio", :jwt do
  ...
  path "/profile_bio/preferences/update" do
    put "Update a Prefence" do
      tags "update"
      ...
      response "200", "Prefence updated successfully" do
      ...
      response "404", "record not found" do
        let(:token) { BuilderJsonWebToken.encode(account1.id + 10, 1.day.from_now, token_type: "login") }
        let(:params) do
          {
            data:{
              attributes: {
