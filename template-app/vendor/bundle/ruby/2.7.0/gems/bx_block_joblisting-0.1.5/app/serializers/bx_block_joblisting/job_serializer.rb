...
module BxBlockJoblisting
  ...
  class JobSerializer < BuilderBase::BaseSerializer
    attributes(:company_page_id, :job_title, :remote_job, :location, :employment_type_id, :total_inteview_rounds, :question_answer_id, :job_video_url,
               :job_description, :salary, :seniority_level, :job_function, :industry_id, :other_skills, :skill_id, :preffered_location, :addresses, :profile_id, :created_at, :sub_emplotyment_type)
