...
module Aws::WorkMailMessageFlow
  ...
  class Client < Seahorse::Client::Base
    ...
    @identifier = :workmailmessageflow
    ...
    #
    # @return [Types::GetRawMessageContentResponse] Returns a {Seahorse::Client::Response response} object which responds to the following methods:
    #
    #   * {Types::GetRawMessageContentResponse#message_content #message_content} => IO
    #
    ...
    #
    #   resp.message_content #=> IO
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/workmailmessageflow-2019-05-01/GetRawMessageContent AWS API Documentation
    #
    ...
    def build_request(operation_name, params = {})
      ...
      tracer = config.telemetry_provider.tracer_provider.tracer(
        Aws::Telemetry.module_to_tracer_name('Aws::WorkMailMessageFlow')
      )
