...
module Aws::KinesisVideoWebRTCStorage
  ...
  class Client < Seahorse::Client::Base
    ...
    @identifier = :kinesisvideowebrtcstorage
    ...
    #     sending the request.
    #
    #   @option options [Aws::KinesisVideoWebRTCStorage::EndpointProvider] :endpoint_provider
    #     The endpoint provider used to resolve endpoints. Any object that responds to
    #     `#resolve_endpoint(parameters)` where `parameters` is a Struct similar to
    #     `Aws::KinesisVideoWebRTCStorage::EndpointParameters`.
    #
    ...
    #
    #   resp = client.join_storage_session({
    #     channel_arn: "ChannelArn", # required
    #   })
    #
    # @see http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-webrtc-storage-2018-05-10/JoinStorageSession AWS API Documentation
    #
    # @overload join_storage_session(params = {})
    # @param [Hash] params ({})
    def join_storage_session(params = {}, options = {})
      req = build_request(:join_storage_session, params)
