module BxBlockFavourites
  class UserFollowerSerializer < BuilderBase::BaseSerializer
    attributes :id, :account_id, :follow_id, :created_at, :updated_at

    attribute :is_followings do |object|
       followings = BxBlockFavourites::Follow.where(account_id: object.account_id, follow_id: object.follow_id).present?
       followings
    end
